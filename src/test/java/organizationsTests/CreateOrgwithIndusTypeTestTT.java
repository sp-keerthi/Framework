...
public class CreateOrgwithIndusTypeTestTT {
	...
	@Test
	public void createMultipleOrg(String ORG,String INDUSTRYNAME,String TYPE) throws IOException, InterruptedException
	{
	  ...
	  //step 7:create new Organization with mandatory fields
	       ...
	       cnop.createNewOrganization(ORGNAME,INDUSTRYNAME,TYPE);
